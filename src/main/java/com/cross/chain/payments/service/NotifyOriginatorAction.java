...
@Slf4j
@Service
public class NotifyOriginatorAction implements Action<TransferState, TransferEvent> {
    @Override
    public void execute(StateContext<TransferState, TransferEvent> context) {
        ...
        System.out.println("Notification to Originator for PaymentID:" + paymentId);
    }
}
